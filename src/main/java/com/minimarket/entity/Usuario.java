...
public class Usuario {
    ...
    @Schema(description = "Nombre de usuario unico para autenticarse.", example = "admin",
            requiredMode = Schema.RequiredMode.REQUIRED)
    private String username;

    @Column(nullable = false)
    @Schema(description = "Contrasena del usuario (se almacena cifrada con BCrypt). Solo escritura.",
